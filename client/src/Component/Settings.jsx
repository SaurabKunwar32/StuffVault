...
import {
    fetchUser, updateUser, setUserPassword, changeUserPassword, logoutAllSessions,
...
export default function Settings() {
    ...
    async function handleChangePassword() {
        ...
        if (newPassword.length < 4) { // fixed length check
            return setNotificationPopup({
    ...
    async function handleSetPassword() {
        ...
        if (newPassword.length < 4) { // fixed to match your message
            return setNotificationPopup({
                message: "Password must be at least 4 characters.",
                type: "error",
            });
